...
#include <iostream>
#include <Windows.h>
DWORD getHashFromStrings(char* string)
{
...
PDWORD getFunctionAddressByHashs(char* library, DWORD hash)
{
	...
	for (DWORD i = 0; i < imageExportDirectory->NumberOfFunctions; i++)
	{
		...
		DWORD functionNameHash = getHashFromStrings(functionName);
...
using customCreateThreads = HANDLE(NTAPI*)(
