...
void FNClean() {
	...
	killer();
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\ControlSet001\\Services\\EpicOnlineServices\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKCU\\SOFTWARE\\Epic Games\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SOFTWARE\\Classes\\com.epicgames.launcher\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\ControlSet001\\Services\\BEService\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\ControlSet001\\Services\\BEDaisy\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\ControlSet001\\Services\\EasyAntiCheat\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\BEService\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\BEDaisy\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SOFTWARE\\WOW6432Node\\EasyAntiCheat\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SOFTWARE\\WOW6432Node\\Epic Games\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\CapabilityAccessManager\\ConsentStore\\microphone\\""NonPackaged\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SOFTWARE\\Microsoft\\RADAR\\HeapLeakDetection\\DiagnosedApplications\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKCU\\Software\\Microsoft\\Windows\\Shell\\Associations\\UrlAssociations\\com.epicgames.launcher\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKCR\\com.epicgames.eos\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SOFTWARE\\Microsoft\\RADAR\\HeapLeakDetection\\DiagnosedApplications\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SOFTWARE\\EpicGames\" /f > nul 2>&1").decrypt());
	 system(skCrypt("reg delete \"HKEY_USERS\\S-1-5-18\\Software\\Epic Games\" /f > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\EpicGamesLauncher\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\FortniteGame\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\Epic Games\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\NVIDIA Corporation\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Users\\%username%\\AppData\\Roaming\\EasyAntiCheat\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Users\\All Users\\Epic\\EpicGamesLauncher\\Data\\EMS\\current\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\UnrealEngine\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\UnrealEngineLauncher\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\ProgramData\\Epic\\EpicOnlineServices\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\ProgramData\\Epic\\EpicGamesLauncher\\Data\\EMS\\current\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Program Files (x86)\\Epic Games\\Epic Online Services\\service\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Program Files\\Epic Games\\Fortnite\\FortniteGame\\Binaries\\Win64""\\Shared Files\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Program Files (x86)\\Common Files\\BattlEye\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /S /Q \"%systemdrive%\\Program Files (x86)\\EasyAntiCheat\" > nul 2>&1").decrypt());
	 system(skCrypt("RMDIR /s /Q \"%systemdrive%\\$Recycle.bin\" > nul 2>&1").decrypt());
	 system(skCrypt("el /q \"%systemdrive%\\ProgramData\\Microsoft\\Windows\\WER\\Temp\\\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\ProgramData\\Microsoft\\Windows\\WER\\Temp\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\Temp\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Users\\%username%\\AppData\\Local\\Temp\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Windows\\Temp\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Windows\\Temp\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Windows\\TEMP\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Windows\\TEMP\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Windows\\temp\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Windows\\temp\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Program Files (x86)\\Temp\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Program Files (x86)\\Temp\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Windows\\Logs\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Windows\\Logs\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\D3DSCache\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Users\\%username%\\AppData\\Local\\D3DSCache\\*\") do @rd /s /q ""\"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\CrashReportClient\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Users\\%username%\\AppData\\Local\\CrashReportClient\\*\") do @r""d /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Windows\\Prefetch\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Windows\\Prefetch\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Users\\%username%\\Recent\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Users\\%username%\\Recent\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\AMD\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Users\\%username%\\AppData\\Local\\AMD\\*\") do @rd /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\AMD_Common\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Users\\%username%\\AppData\\Local\\AMD_Common\\*\") do @rd /s /q"" \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /q \"%systemdrive%\\Users\\%username%\\AppData\\Local\\Microsoft\\Feeds\\*\" > nul 2>&1").decrypt());
	 system(skCrypt("for /d %x in (\"%systemdrive%\\Users\\%username%\\AppData\\Local\\Microsoft\\Feeds\\*\") do @rd"" /s /q \"%x\" > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\Users\\%username%\\AppData\\Local\\Microsoft\\Windows\\INetCookies\\ > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\Users\\%username%\\AppData\\Local\\Microsoft\\Windows\\History\\ > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\Users\\%username%\\AppData\\Local\\Microsoft\\Windows\\INetCache\\ > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\Users\\%username%\\AppData\\Local\\Temp\\ > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\Windows\\Temp\\ > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\Windows\\Prefetch\\ > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\Temp\\ > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.etl > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.log > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.tmp > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.old > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.bak > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.bac > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.bup > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.chk > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.dmp > nul 2>&1").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.temp > nul 2>&1").decrypt());
	 system(skCrypt("reg delete HKEY_LOCAL_MACHINE\\SYSTEM\\ControlSet001\\Services\\BEService /f").decrypt());
	 system(skCrypt("reg delete HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\BEService /f").decrypt());
	 system(skCrypt("reg delete HKEY_LOCAL_MACHINE\\SYSTEM\\ControlSet001\\Services\\EasyAntiCheat /f").decrypt());
	 system(skCrypt("reg delete HKEY_LOCAL_MACHINE\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat /f").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Program Files (x86)\\Common Files\\BattlEye\\BEService.exe\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Program Files (x86)\\Common Files\\BattlEye\\BEService_fn.exe\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\AMD\\CN\\GameReport\\FortniteClient-Win64-Shipping.exe\\gpa.bin\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\AMD\\DxCache\\92b1da15789e5451b49097cdafa85ec0f45214d6b0df9e8d.bin\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\AMD\\DxCache\\92b1da15789e5451e900a9bc20b57cd2f45214d6b0df9e8d.bin\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\AMD\\cl.cache\\x64\\Version 2.1 AMD-APP (3380.6).Ellesmere.cache\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\D3DSCache\\e4548a4577c56a84\\52264C4C-172F-41B9-91B8-7F0C3B1E9021_VEN_1002&DEV_67DF&SUBSYS_C580&REV_E7.idx\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\D3DSCache\\e4548a4577c56a84\\52264C4C-172F-41B9-91B8-7F0C3B1E9021_VEN_1002&DEV_67DF&SUBSYS_C580&REV_E7.lock\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\D3DSCache\\e4548a4577c56a84\\52264C4C-172F-41B9-91B8-7F0C3B1E9021_VEN_1002&DEV_67DF&SUBSYS_C580&REV_E7.val\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\NVIDIA Corporation\\GfeSDK\\FortniteClient-Win64-Shipping_12856.log\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\Microsoft\\Windows\\INetCookies\\\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\Microsoft\\Windows\\History\\\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\Microsoft\\Windows\\INetCache\\\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\Temp\\\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Windows\\Temp\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Windows\\Prefetch\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Temp\\\"").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.etl").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.log").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.tmp").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.old").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.bak").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.bac").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.bup").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.chk").decrypt());

	 system(skCrypt("/q %systemdrive%\\*.dmp").decrypt());
	 system(skCrypt("del /f /s /q %systemdrive%\\*.temp").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\Temp\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Windows\\Prefetch\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Program Files (x86)\\EasyAntiCheat\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\EpicGamesLauncher\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Program Files (x86)\\Common Files\\BattlEye\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\AMD\\CN\\GameReport\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\AMD\\CN\\GameReport\\FortniteClient-Win64-Shipping.exe\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\AMD\\cl.cache\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\AMD\\cl.cache\\x64\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\D3DSCache\\e4548a4577c56a84\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\NVIDIA Corporation\\GfeSDK\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\UnrealEngine\\5.0\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\CrashReportClient\"").decrypt());
	 system(skCrypt("del /f /s /q \"C:\\Users\\%username%\\AppData\\Local\\FortniteGame\"").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SOFTWARE\\WOW6432Node\\EasyAntiCheat\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\bam\\State\\UserSettings\\S-1-5-21-2532382528-581214834-2534474248-1001\\Device\\HarddiskVolume3\\Program Files\\Epic Games\\Fortnite\\FortniteGame\\Binaries\\Win64\\FortniteClient-Win64-Shipping_EAC.exe:  B1 8A B0 E9 8D 13 D5 01 00 00 00 00 00 00 00 00 00 00 00 00 02 00 00 00\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\bam\\State\\UserSettings\\S-1-5-21-2532382528-581214834-2534474248-1001\\Device\\HarddiskVolume3\\Program Files\\Epic Games\\Fortnite\\FortniteGame\\Binaries\\Win64\\EasyAntiCheat\\EasyAntiCheat_Setup.exe:  73 D5 4B 11 8D 13 D5 01 00 00 00 00 00 00 00 00 00 00 00 00 02 00 00 00\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\bam\\State\\UserSettings\\S-1-5-21-2532382528-581214834-2534474248-1001\\Device\\HarddiskVolume3\\Program Files\\Epic Games\\Fortnite\\FortniteGame\\Binaries\\Win64\\FortniteClient-Win64-Shipping.exe:  E7 CB 84 E9 8D 13 D5 01 00 00 00 00 00 00 00 00 00 00 00 00 02 00 00 00\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\Type: 0x00000010\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\Start: 0x00000003\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\ErrorControl: 0x00000001\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\ImagePath: \"%systemdrive%\\Program Files (x86)\\EasyAntiCheat\\EasyAntiCheat.exe\"\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\DisplayName: \"EasyAntiCheat\"\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\WOW64: 0x0000014C\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\ObjectName: \"LocalSystem\"\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\Description: \"Provides integrated security and services for online multiplayer games.\" /f").decrypt());
	 system(skCrypt("reg delete \"HKLM\\SYSTEM\\CurrentControlSet\\Services\\EasyAntiCheat\\Security\\Security:  01 00 14 80 A0 00 00 00 AC 00 00 00 14 00 00 00 30 00 00 00 02 00 1C 00 01 00 00 00 02 80 14 00 FF 01 0F 00 01 01 00 00 00 00 00 01 00 00 00 00 02 00 70 00 05 00 00 00 00 00 14 00 30 00 02 00 01 01 00 00 00 00 00 01 00 00 00 00 00 00 14 00 FD 01 02 00 01 01 00 00 00 00 00 05 12 00 00 00 00 00 18 00 FF 01 0F 00 01 02 00 00 00 00 00 05 20 00 00 00 20 02 00 00 00 00 14 00 8D 01 02 00 01 01 00 00 00 00 00 05 04 00 00 00 00 00 14 00 8D 01 02 00 01 01 00 00 00 00 00 05 06 00 00 00 01 01 00 00 00 00 00 05 12 00 00 00 01 01 00 00 00 00 00 05 12 00 00 00\" /f\"").decrypt());

	system(skCrypt("netsh advfirewall reset > nul 2>&1").decrypt());
...
void hardclean() {
	 killer();
	 system(skCrypt("del \"%localappdata%\\microsoft\\feeds\" /s /f /q").decrypt());
	 system(skCrypt("del \"%systemdrive%\\users\\%username%\\appdata\\local\\epicgameslauncher\\saved\\webcache\\cookies\"").decrypt());
	 system(skCrypt("del \"%temp%\\getadmin.vbs\"").decrypt());
	 system(skCrypt("del \"c:\\programdata\\microsoft\\search\\data\\applications\\windows\\edb.jcp\"").decrypt());
	 system(skCrypt("del \"c:\\recovery\\ntuser.sys\"").decrypt());
	 system(skCrypt("del \"c:\\system volume information\\indexervolumeguid\"").decrypt());
	 system(skCrypt("del \"c:\\system volume information\\tracking.log\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\locallow\\microsoft\\cryptneturlcache\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\locallow\\microsoft\\cryptneturlcache\\content\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\locallow\\microsoft\\cryptneturlcache\\content\\77ec63bda74bd0d0e0426dc8f8008506\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\locallow\\microsoft\\cryptneturlcache\\content\\fb0d848f74f70bb2eaa93746d24d9749\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\locallow\\microsoft\\cryptneturlcache\\metadata\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\locallow\\microsoft\\cryptneturlcache\\metadata\\77ec63bda74bd0d0e0426dc8f8008506\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\locallow\\microsoft\\cryptneturlcache\\metadata\\fb0d848f74f70bb2eaa93746d24d9749\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\crashdumps\\backgr~2.dmp\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\epicgameslauncher\\saved\\webcache\\cookies\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\microsoft\\feeds cache\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\microsoft\\feeds\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\microsoft\\windows\\webcache\\v01.chk\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\microsoft\\windows\\webcache\\v0100024.log\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\microsoft\\windows\\webcache\\webcac~1.dat\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\microsoft\\windows\\webcache\\webcac~1.jfm\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\nordvpn\\logs\\app-2019-12-09.nwl\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\nvidia corporation\\gfesdk\\fortni~1.log\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\packages\\microsoft.windows.cortana_cw5n1h2txyewy\\appdata\\cachestorage\\caches~1.jfm\"").decrypt());
	 system(skCrypt("del \"c:\\users\\%username%\\appdata\\local\\temp\\ecache.bin\"").decrypt());
	// Continuing with the rest of the commands...
	 system(skCrypt("del \"c:\\users\\all users\\microsoft\\search\\data\\applications\\windows\\edb.jcp\"").decrypt());
	 system(skCrypt("del \"c:\\users\\all users\\microsoft\\search\\data\\applications\\windows\\projects\\systemindex\\propmap\\cipt0000.000\"").decrypt());
	 system(skCrypt("del \"c:\\users\\all users\\microsoft\\windows\\wer\\temp\\wer5cc2.tmp.xml\"").decrypt());
	 system(skCrypt("del \"c:\\users\\all users\\microsoft\\windows\\wer\\temp\\wer95df.tmp.mdmp\"").decrypt());
	 system(skCrypt("del \"c:\\users\\public\\shared files\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\cbstemp\\30780525_1668355464\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\bthpan.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\e2xw10x64.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\e2xw10~1.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\ialpss2i_gpio2_skl.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\intelpep.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\monitor.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\msports.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\ndisvirtualbus.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\netathr10x.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\netavpna.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\netrasa.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\netsstpa.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\netvwifimp.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\rdpbus.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\usbxhci.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\inf\\wmiacpi.pnf\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\logs\\cbs\\cbs.log\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\system32\\wbem\\repository\\mapping1.map\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\system32\\wbem\\repository\\writable.tst\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\temp\\206f3fdc-b1a8-4fd6-bdb8-6cfe76122873\"").decrypt());
	 system(skCrypt("del \"c:\\windows\\temp\\6e04ef32-0387-48b1-b812-ac2bba90a8d0\"").decrypt());
	 system(skCrypt("del /q /f %windir%\\kb*.log").decrypt());
	 system(skCrypt("del /q /f /a /s \"c:\\users\\%username%\\appdata\\local\\iconcache.db\"").decrypt());
	 system(skCrypt("del /q /f /a /s \"c:\\users\\%username%\\appdata\\local\\updater.log\"").decrypt());
	 system(skCrypt("del /f \"c:\\programdata\\microsoft\\windows\\devicemetadatacache\\dmrc.idx\"").decrypt());
	 system(skCrypt("del /f \"c:\\system volume information\\tracking.log\"").decrypt());
	 system(skCrypt("del /f \"c:\\users\\%username%\\appdata\\local\\ac\\inetcookies\\ese\\container.dat\"").decrypt());
	 system(skCrypt("del /f \"c:\\users\\%username%\\appdata\\local\\microsoft\\onedrive\\logs\\common\\devicehealthsummaryconfiguration.ini\"").decrypt());
	 system(skCrypt("del /f \"c:\\users\\%username%\\appdata\\local\\microsoft\\vault\\userprofileroaming\\latest.dat\"").decrypt());
	 system(skCrypt("del /f \"c:\\users\\%username%\\appdata\\local\\microsoft\\windows\\inetcache\\ie\\container.dat\"").decrypt());
	 system(skCrypt("del /f \"c:\\users\\%username%\\appdata\\local\\unrealengine\\4.23\\saved\\config\\windowsclient\\manifest.ini\"").decrypt());
	 system(skCrypt("del /f \"c:\\users\\%username%\\ntuser.ini\"").decrypt());
	 system(skCrypt("del /f \"c:\\windows\\win.ini\"").decrypt());
	 system(skCrypt("del /f /q \"%userprofile%\\recent\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%appdata%\\roaming\\easyanticheat\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%paint\\users\\%username%\\appdata\\roaming\\vstelemetry\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\desktop.ini\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\intel\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\msocache\\{71230000-00e2-0000-1000-00000000}\\setup.dat\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\msocache\\{71230000-00e2-0000-1000-00000000}\\setup.dat\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\program files (x86)\\easyanticheat\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\program files (x86)\\easyanticheat\\easyanticheat.sys\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\electronic arts\\*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\electronic arts\\ea services\\license\\*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\electronic arts\\ea services\\license\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\microsoft\\datamart\\paidwifi\\networkscache\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\microsoft\\datamart\\paidwifi\\networkscache\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\microsoft\\datamart\\paidwifi\\rules\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\microsoft\\datamart\\paidwifi\\rules\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\microsoft\\windows\\wer\\temp\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\programdata\\microsoft\\windows\\wer\\temp\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\recovery\\ntuser.sys\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\system volume information\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\temp\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\users\\%%username%%\\appdata\\local\\unrealengine\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\users\\%username%\\appdata\\local\\microsoft\\feeds\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\users\\%username%\\appdata\\local\\microsoft\\windows\\history\\history.ie5\\*.*\"").decrypt());
	 system(skCrypt("del /f /s /q \"%systemdrive%\\users\\%username%\\appdata\\local\\microsoft\\windows\\history\\history.ie5\\*.*\"").decrypt());
